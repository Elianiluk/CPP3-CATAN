...
namespace ariel
{
        ...
        {
                std::cout << "            " << this->board[0]->getVertex(0)->getVertexKind() << "      " << this->board[1]->getVertex(0)->getVertexKind() << "       " << this->board[2]->getVertex(0)->getVertexKind() << "\n"
                          ...
                          << "         " << this->board[0]->getVertex(1)->getVertexKind() << "     " << this->board[0]->getVertex(5)->getVertexKind() << "       " << this->board[1]->getVertex(5)->getVertexKind() << "      " << this->board[2]->getVertex(5)->getVertexKind() << "\n"
                          << "         " << this->board[0]->getEdge(1)->getColor() << "| " << this->board[0]->getSymbol() << this->board[0]->getEdge(4)->getColor() << "  |" << "  " << this->board[1]->getSymbol() << this->board[1]->getEdge(4)->getColor() << "   |  " << this->board[2]->getSymbol() << "  " << this->board[2]->getEdge(4)->getColor() << "|\033[0m\n"
                          << "         " << this->board[0]->getVertex(2)->getVertexKind() << " " << this->board[0]->getNum() << "  " << this->board[0]->getVertex(4)->getVertexKind() << "   " << this->board[1]->getNum() << "   " << this->board[1]->getVertex(4)->getVertexKind() << "   " << this->board[2]->getNum() << "  " << this->board[2]->getVertex(4)->getVertexKind() << "\n"
                          ...
                          << "      " << this->board[3]->getVertex(1)->getVertexKind() << "     " << this->board[3]->getVertex(5)->getVertexKind() << "      " << this->board[4]->getVertex(5)->getVertexKind() << "      " << this->board[5]->getVertex(5)->getVertexKind() << "      " << this->board[6]->getVertex(5)->getVertexKind() << "\n"
                          << "      " << this->board[3]->getEdge(1)->getColor() << "| " << this->board[3]->getSymbol() << this->board[3]->getEdge(4)->getColor() << "  |  " << this->board[4]->getSymbol() << this->board[4]->getEdge(4)->getColor() << "  |  " << this->board[5]->getSymbol() << this->board[5]->getEdge(4)->getColor() << "  |  " << this->board[6]->getSymbol() << "  " << this->board[6]->getEdge(4)->getColor() << "|\033[0m\n"
                          << "      " << this->board[3]->getVertex(2)->getVertexKind() << " " << this->board[3]->getNum() << "  " << this->board[3]->getVertex(4)->getVertexKind() << "   " << this->board[4]->getNum() << "   " << this->board[4]->getVertex(4)->getVertexKind() << "  " << this->board[5]->getNum() << "  " << this->board[5]->getVertex(4)->getVertexKind() << "  " << this->board[6]->getNum() << "  " << this->board[6]->getVertex(4)->getVertexKind() << "\n"
                          ...
                          << "   " << this->board[7]->getVertex(1)->getVertexKind() << "     " << this->board[7]->getVertex(5)->getVertexKind() << "      " << this->board[8]->getVertex(5)->getVertexKind() << "      " << this->board[9]->getVertex(5)->getVertexKind() << "     " << this->board[10]->getVertex(5)->getVertexKind() << "      " << this->board[11]->getVertex(5)->getVertexKind() << "\n"
                          << "   " << this->board[7]->getEdge(1)->getColor() << "| " << this->board[7]->getSymbol() << this->board[7]->getEdge(4)->getColor() << "  |  " << this->board[8]->getSymbol() << this->board[8]->getEdge(4)->getColor() << "  |  " << this->board[9]->getSymbol() << this->board[9]->getEdge(4)->getColor() << "   | " << this->board[10]->getSymbol() << this->board[10]->getEdge(4)->getColor() << "  |  " << this->board[11]->getSymbol() << "  " << this->board[11]->getEdge(4)->getColor() << "|\033[0m\n"
                          << "   " << this->board[7]->getVertex(2)->getVertexKind() << "  " << this->board[7]->getNum() << "  " << this->board[7]->getVertex(4)->getVertexKind() << "  " << this->board[8]->getNum() << "  " << this->board[8]->getVertex(4)->getVertexKind() << "   " << this->board[9]->getNum() << "  " << this->board[9]->getVertex(4)->getVertexKind() << "  " << this->board[10]->getNum() << "  " << this->board[10]->getVertex(4)->getVertexKind() << "   " << this->board[11]->getNum() << "  " << this->board[11]->getVertex(4)->getVertexKind() << "\n"
                          ...
                          << "      " << this->board[12]->getVertex(1)->getVertexKind() << "     " << this->board[12]->getVertex(5)->getVertexKind() << "      " << this->board[13]->getVertex(5)->getVertexKind() << "      " << this->board[14]->getVertex(5)->getVertexKind() << "      " << this->board[15]->getVertex(5)->getVertexKind() << "\n"
                          << "      " << this->board[12]->getEdge(1)->getColor() << "| " << this->board[12]->getSymbol() << this->board[12]->getEdge(4)->getColor() << "  |  " << this->board[13]->getSymbol() << this->board[13]->getEdge(4)->getColor() << "  |  " << this->board[14]->getSymbol() << this->board[14]->getEdge(4)->getColor() << "  |  " << this->board[15]->getSymbol() << this->board[15]->getEdge(4)->getColor() << "  |\033[0m\n"
                          << "      " << this->board[12]->getVertex(2)->getVertexKind() << "  " << this->board[12]->getNum() << "  " << this->board[12]->getVertex(4)->getVertexKind() << "   " << this->board[13]->getNum() << "  " << this->board[13]->getVertex(4)->getVertexKind() << "   " << this->board[14]->getNum() << "  " << this->board[14]->getVertex(4)->getVertexKind() << "   " << this->board[15]->getNum() << "  " << this->board[15]->getVertex(4)->getVertexKind() << "\n"
                          ...
                          << "         " << this->board[16]->getVertex(1)->getVertexKind() << "      " << this->board[16]->getVertex(5)->getVertexKind() << "      " << this->board[17]->getVertex(5)->getVertexKind() << "      " << this->board[18]->getVertex(5)->getVertexKind() << "\n"
                          << "         " << this->board[16]->getEdge(1)->getColor() << "|  " << this->board[16]->getSymbol() << this->board[16]->getEdge(4)->getColor() << "  |  " << this->board[17]->getSymbol() << this->board[17]->getEdge(4)->getColor() << "  |  " << this->board[18]->getSymbol() << this->board[18]->getEdge(4)->getColor() << "  |\033[0m\n"
                          << "         " << this->board[16]->getVertex(2)->getVertexKind() << "   " << this->board[16]->getNum() << "  " << this->board[16]->getVertex(4)->getVertexKind() << "   " << this->board[17]->getNum() << "  " << this->board[17]->getVertex(4)->getVertexKind() << "   " << this->board[18]->getNum() << " " << this->board[18]->getVertex(4)->getVertexKind() << "\n"
                          ...
                          << "             " << this->board[16]->getVertex(3)->getVertexKind() << "      " << this->board[17]->getVertex(3)->getVertexKind() << "      " << this->board[18]->getVertex(3)->getVertexKind() << "\n";
        }
